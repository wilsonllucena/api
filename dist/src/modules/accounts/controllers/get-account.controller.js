...
let GetAccountController = class GetAccountController {
    getAccountUseCase;
    ...
    async handle(request) {
        ...
        return (0, helpers_1.success)(response.value, http_status_code_1.httpStatus.OK);
    }
};
GetAccountController = __decorate([
    __param(0, (0, tsyringe_1.inject)('GetAccount')),
    __metadata("design:paramtypes", [Object])
], GetAccountController);
exports.GetAccountController = GetAccountController;
//# sourceMappingURL=get-account.controller.js.map