...
let CreateAccountController = class CreateAccountController {
    ...
    async handle(data) {
        ...
        if (response.isLeft()) {
            return (0, helpers_1.badRequest)(response.value, http_status_code_1.httpStatus.CONFLICT);
        }
        return (0, helpers_1.success)(response.value, http_status_code_1.httpStatus.CREATED);
    }
};
CreateAccountController = __decorate([
    __param(0, (0, tsyringe_1.inject)('CreateAccount')),
